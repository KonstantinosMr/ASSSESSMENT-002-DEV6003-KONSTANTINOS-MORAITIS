<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="ASSSESSMENT_002_DEV6003_KONSTANTINOS_MORAITIS.Account.OpenAuthProviders" %>
